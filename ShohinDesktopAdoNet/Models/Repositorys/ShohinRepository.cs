...
namespace ShohinDesktopAdoNet.Models.Repositorys
{
    ...
    {
        private const string SHOHIN_TABLE = "shohins"; 
        private const string UNIQUE_ID = "unique_id"; 
        private const string SHOHIN_CODE = "shohin_code"; 
        private const string SHOHIN_NAME = "shohin_name"; 
        private const string EDIT_DATE = "updated_on"; 
        private const string EDIT_TIME = "updated_at"; 
